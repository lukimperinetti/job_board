...
const SignUP = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (formData.signupPassword !== formData.signupConfirmPassword) {
            ...
            const data = {
                firstname: formData.UserFirstname, //jobTittle = c'est l'id donné a mon champ (id="jobTitle")
    ...
    return (
        <div className="box2">
            <div className="forms form__login" style={{ width: "450px" }}>
                ...
                <form className="form2" id="signupForm" style={{ height: "400px" }} onSubmit={handleSubmit}>
                    ...
                    <div className="log__remember log__box">
                        <input
                            ...
                            id="terms"
                        />
                        <label htmlFor="log--accept" style={{ color: "black" }}> <strong>I Accept the terms & conditions</strong></label>
                    </div>
                    ...
                    <div className="form__text">
                        <p style={{ width: "300px" }}> <strong>already have an Account ?</strong></p>
                        <Link to="/jobs/login">
